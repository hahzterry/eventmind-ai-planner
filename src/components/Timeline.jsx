        ...
        <div>
          ...
          <div className="card mt-2">
            ...
            {["high", "medium", "low"].map(p => {
              ...
              const pdone = ptasks.filter((_, i) => checked[sorted.indexOf(sorted.find(t => t.priority === p && !Object.values(checked).includes(false)))]).length;
              return (
                <div key={p} className="flex justify-between items-center" style={{ padding: "8px 0", borderBottom: "1px solid var(--border)" }}>
                  ...
                  <span style={{ fontSize: "13px", color: "var(--text2)" }}>{ptasks.length} tasks</span>
                </div>
              );
            })}
          </div>
